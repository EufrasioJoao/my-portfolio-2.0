    ...
    <main className="min-h-screen bg-white text-black p-8 max-w-[210mm] mx-auto">
      ...
      <section className="mb-6">
        ...
        <p className="text-sm leading-relaxed">
          Desenvolvedor backend com mais de 5 anos de experiência projetando e
          construindo aplicações server-side e APIs escaláveis. Especialista em
          Node.js, Express e design de bancos de dados com forte conhecimento em
          arquitetura de sistemas, segurança e otimização de performance.
          Histórico comprovado de construir sistemas backend robustos que lidam
          com milhares de usuários simultâneos.
        </p>
      </section>
      ...
      <section className="mb-6">
        ...
        <div className="space-y-3 text-sm">
          ...
          <div>
            ...
            <p className="text-gray-700">
              MySQL, PostgreSQL, MongoDB, Redis, Design de BD, Otimização de
              Queries
            </p>
          </div>
          <div>
            ...
            <p className="text-gray-700">
              Prisma, Sequelize, Mongoose, TypeORM, Migrações de Banco de Dados
            </p>
          </div>
          <div>
            <p className="font-semibold mb-1">APIs & Integração:</p>
            <p className="text-gray-700">
              APIs RESTful, GraphQL, WebSockets, Design de APIs, Integrações
              Third-party
            </p>
          </div>
          <div>
            ...
            <p className="text-gray-700">
              JWT, OAuth, bcrypt, Segurança de APIs, CORS, Rate Limiting,
          ...
          <div>
            ...
            <p className="text-gray-700">
              API OpenAI, Gemini AI, API WhatsApp, Gateways de Pagamento,
              Serviços de Email
            </p>
          </div>
        </div>
      ...
      <section className="mb-6">
        ...
        <div className="mb-4">
          ...
          <ul className="list-disc list-inside text-sm space-y-1 text-gray-800">
            <li>
              Projetei e implementei APIs RESTful servindo milhares de
              requisições por dia
            </li>
            <li>
              Construí schemas de banco de dados escaláveis com Prisma e
              PostgreSQL
            </li>
            <li>Implementei sistemas de autenticação e autorização com JWT</li>
            <li>
              Otimizei queries de banco de dados reduzindo tempo de resposta em
              60%
            </li>
            <li>
              Integrei serviços third-party incluindo gateways de pagamento e
              APIs de IA
            </li>
          </ul>
          <p className="text-xs text-gray-600 mt-2">
            <span className="font-semibold">Tecnologias:</span> Node.js,
        ...
        <div className="mb-4">
          ...
          <ul className="list-disc list-inside text-sm space-y-1 text-gray-800">
            <li>
              Construí soluções backend personalizadas e APIs para vários
              projetos de clientes
            </li>
            <li>
              Projetei arquiteturas de banco de dados para requisitos de negócio
              complexos
            </li>
            <li>
              Implementei recursos em tempo real usando WebSockets e arquitetura
              event-driven
            </li>
            <li>
              Integrei serviços de IA (OpenAI, Gemini) para automação
              inteligente
            </li>
            <li>Implantei e mantive aplicações em AWS e plataformas cloud</li>
          </ul>
          <p className="text-xs text-gray-600 mt-2">
            <span className="font-semibold">Tecnologias:</span> Node.js, Python,
            MySQL, MongoDB, AWS
          </p>
        </div>
        ...
        <div className="mb-4">
          ...
          <ul className="list-disc list-inside text-sm space-y-1 text-gray-800">
            ...
            <li>
              Projetei e implementei schemas de banco de dados com MongoDB
            </li>
            <li>
              Implementei validação de dados, tratamento de erros e sistemas de
              logging
            </li>
      ...
      <section className="mb-6">
        ...
        <div className="space-y-3">
          ...
          <div>
            <h3 className="text-lg font-bold">
              Flock - Backend Rede Social Empresarial
            </h3>
            <p className="text-sm text-gray-800 mb-1">
              Arquitetei e construí a infraestrutura backend completa incluindo
              autenticação de usuários, perfis de empresas, gestão de projetos e
              sistemas de eventos. Implementei notificações em tempo real e
              sistema de convites com lógica de autorização complexa.
            </p>
          ...
          <div>
            <h3 className="text-lg font-bold">
              Fluxime - Backend Gestão Financeira
            </h3>
            <p className="text-sm text-gray-800 mb-1">
              Construí um sistema backend robusto lidando com transações
              financeiras, integração WhatsApp com IA e lógica de negócio
              complexa. Implementei processamento seguro de pagamentos e
              controle de acesso multiusuário. Serve 1.000+ usuários ativos com
              99.9% uptime.
            </p>
            <p className="text-xs text-gray-600">
              <span className="font-semibold">Tecnologias:</span> Node.js,
              Prisma, MySQL, Gemini AI, API WhatsApp
            </p>
          </div>
        </div>
      </section>

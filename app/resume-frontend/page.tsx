    ...
    <main className="min-h-screen bg-white text-black p-8 max-w-[210mm] mx-auto">
      ...
      <section className="mb-6">
        ...
        <p className="text-sm leading-relaxed">
          Frontend developer with 5+ years of experience building modern,
          responsive, and performant web applications. Expert in React, Next.js,
          and TypeScript with a strong focus on user experience, accessibility,
          and clean code. Proven track record of creating pixel-perfect
          interfaces and implementing complex UI/UX designs that delight users.
        </p>
      </section>
      ...
      <section className="mb-6">
        ...
        <div className="space-y-3 text-sm">
          ...
          <div>
            ...
            <p className="text-gray-700">
              Tailwind CSS, CSS Modules, Styled Components, SASS/SCSS,
              Responsive Design
            </p>
          </div>
          <div>
          ...
          <div>
            ...
            <p className="text-gray-700">
              Framer Motion, CSS Animations, GSAP, React Spring
            </p>
          </div>
          <div>
      ...
      <section className="mb-6">
        ...
        <div className="mb-4">
          ...
          <ul className="list-disc list-inside text-sm space-y-1 text-gray-800">
            <li>
              Built responsive and accessible web applications using React and
              Next.js
            </li>
            <li>
              Implemented pixel-perfect UI designs with Tailwind CSS and modern
              CSS techniques
            </li>
            <li>
        ...
        <div className="mb-4">
          ...
          <ul className="list-disc list-inside text-sm space-y-1 text-gray-800">
            <li>
              Delivered custom frontend solutions for diverse clients across
              industries
            </li>
            <li>
              Created responsive landing pages and web applications from Figma
              designs
            </li>
            <li>
            ...
            <li>
              Maintained high code quality with TypeScript and modern best
              practices
            </li>
          </ul>
          <p className="text-xs text-gray-600 mt-2">
        ...
        <div className="mb-4">
          ...
          <ul className="list-disc list-inside text-sm space-y-1 text-gray-800">
            ...
            <li>
              Built reusable React components following atomic design principles
            </li>
            <li>
              Implemented form validations and interactive user interfaces
            </li>
            <li>
              Collaborated with backend team to integrate APIs and display data
            </li>
            <li>
      ...
      <section className="mb-6">
        ...
        <div className="space-y-3">
          ...
          <div>
            <h3 className="text-lg font-bold">
              Flock - Business Social Network
            </h3>
            <p className="text-sm text-gray-800 mb-1">
              Built the complete frontend for a business social network with
              complex UI interactions, real-time updates, and responsive design.
              Implemented advanced filtering, search, and profile management
              features.
            </p>
          ...
          <div>
            ...
            <p className="text-sm text-gray-800 mb-1">
              Created an interactive financial dashboard with real-time charts,
              data visualizations, and responsive layouts. Implemented complex
              forms and multi-step workflows for financial management. 1,000+
              active users.
            </p>
            <p className="text-xs text-gray-600">
              <span className="font-semibold">Technologies:</span> Next.js,
              React Query, Tailwind CSS, Chart.js
            </p>
          </div>
        </div>
      </section>
